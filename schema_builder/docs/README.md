...
- SchemaBuilder.md: Provides information for the rules governing how recipes should be evaluted into form schemas.

Also, refer to [Form Processor](/docs/FormProcessor.md) for information about how submitted forms should be processed.
...
- Schema: A resultant schema built from a recipe, that provides all information necessary for a client to interface with the service, and submit responses.
- Schema Builder: Collection of code designed to turn convert a Recipe into a Schema.
